                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">                                                                                                
                                                <div>
                                                    <p class="font-semibold">{{ $mk->mataKuliah->nama }} <?= count($kelas) > 1 ? "*) (".$alphabet[$index].")" : ''?></p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                ...
                                                <form action="{{ route('remove-class', ['id' => $mk->id]) }}" method="post"
                                                    >
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" value="{{$id}}" name="id_matkul">
                                                    <button type="submit"
                    ...
                    <div
                        ...
                        <span class="flex items-center  col-span-3">
                            Showing {{ $kelas->firstItem() }}-{{ $kelas->lastItem() }} of {{ $kelas->total() }}
                        </span>
                        <div
                            class="flex px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
        ...
        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
            ...
            <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                ...
                <div id="modal_tambah_dosen" class="mt-4 mb-6">
                    ...
                    <!-- Modal description -->
                    <form class="grid grid-cols-2" action="{{ route('add-class') }}" method="POST">
                        @csrf
                        <div class="px-4 py-3 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <label class="block text-sm">
                                ...
                                <div
                                    ...
                                    <input name="matkul_id" type="hidden" value="{{$id}}" />
