                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">                                                                                                
                                                <div>
                                                    ...
                                                    <p class="font-semibold">{{ $mk->mataKuliah->nama }} <?= count($mks) > 1 ? "*) (".$alphabet[$index].")" : ''?></p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                ...
                                                <form action="{{ route('remove-class', ['id' => $mk->id]) }}" method="post"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" value="{{$mk->matkul_id}}" name="id_matkul">
                                                    <button type="submit"
