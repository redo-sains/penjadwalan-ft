...
@section('main')
            ...
            <div class="container grid px-6 mx-auto">
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <a href="{{route('export-ruangans-template')}}"
                            class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                            Download Template
                    </a>
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-xs">
                                            <span
                                                ...
                                                {{ strtolower($Ruangan->tipe_ruangan) == 'umum' ?
                                                    $Ruangan->tipe_ruangan : M_jurusan::find($Ruangan->jurusan_id)->nama;
                                                  }}
                                            </span>
                                        </td>
                                        <td class="px-4 py-3">
    ...
    <div id="modal_import" class="mt-4 mb-6 hidden">
        ...
        <!-- Modal description -->
        <form class="grid grid-cols-2" action="{{ route('import-ruangans') }}" method="POST" enctype="multipart/form-data">
            @csrf
