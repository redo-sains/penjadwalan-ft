...
@section('main')
                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                @foreach ($kurikulums as $kurikulum)
                                    ...
                                    <td class="px-4 py-3 text-md uppercase text-green-600">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('edit_kurikulum', ['id' => $kurikulum->id]) }}"
                                            ...
                                            <form action="{{ route('hapus_kurikulum', ['id' => $kurikulum->id]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                    ...
                    <div
                        ...
                        <span class="flex items-center  col-span-3">
                            Showing {{ $kurikulums->firstItem() }}-{{ $kurikulums->lastItem() }} of
                            {{ $kurikulums->total() }}
                        </span>
                        <div
                            class="flex px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
        ...
        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
            ...
            <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                ...
                <div class="mt-4 mb-6">
                    ...
                    <!-- Modal form -->
                    <form class="grid grid-cols-2" action="{{ route('store_kurikulum') }}" method="POST">
                        @csrf
                                ...
                                <div
                                    ...
                                    <select name="semester"
                                        ...
                                        <option value="#" selected disabled>Pilih Semester</option>
                                            <option value="ganjil" class="">
                                                ganjil </option>
                                            <option value="genap" class="">
                                                genap </option>
                                    </select>
                                    <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
    ...
    <script>
        // JavaScript untuk mengaktifkan/menonaktifkan dropdown jurusan berdasarkan tipe kurikulum
        document.querySelector('select[name="tipe_kurikulum"]').addEventListener('change', function() {
