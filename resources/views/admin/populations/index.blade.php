            ...
            <div class="container grid px-6 mx-auto">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <form action="{{ route('kurikum-periode') }}" method="post" id="kurikulumForm">
                            @csrf
                            @method('post') <!-- Pastikan Anda menambahkan CSRF token jika menggunakan Laravel -->
                            <div class="px-4 py-3 mb-2 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                <label class="block text-sm">
                                    <span class="text-gray-700 dark:text-gray-400">Kurikulum</span>
                                    <div
                                        class="relative text-gray-500 focus-within:text-purple-600 dark:focus-within:text-purple-400">
                                        <select name="kurikulum" id="kurikulumSelect"
