                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                @foreach ($ketersediaanDosens as $ketersediaanDosen)
                                    <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    <p class="font-semibold">
                                                        @php
                                                            $dosenNama =
                                                                $dosens->firstWhere('id', $ketersediaanDosen->dosen_id)
                                                                    ->nama ?? 'Tidak ada';
                                                        @endphp
                                                        {{ $dosenNama }}</p>
                                                </div>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            {{ $ketersediaanDosen->hari }}
                                        </td>
                                        <td class="px-4 py-3 text-sm">
                                            {{ $ketersediaanDosen->waktu_mulai }}
                                        </td>
                                        <td class="px-4 py-3 text-sm">
                                            {{ $ketersediaanDosen->waktu_selesai }}
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a href="{{ route('edit_k_dosen', ['id' => $ketersediaanDosen->id]) }}"
                                                ...
                                                <form
                                                    action="{{ route('hapus_k_dosen', ['id' => $ketersediaanDosen->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                    ...
                    <div
                        ...
                        <span class="flex items-center  col-span-3">
                            Showing {{ $ketersediaanDosens->firstItem() }}-{{ $ketersediaanDosens->lastItem() }} of
                            {{ $ketersediaanDosens->total() }}
                        </span>
                        <div
                            class="flex px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
                            <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                                {{ $ketersediaanDosens->links() }}
                            </span>
                        </div>
            ...
            <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                ...
                <div class="mt-4 mb-6">
                    ...
                    <p class="mb-2 px-3 text-lg font-semibold text-gray-700 dark:text-gray-300  ">
                        Masukan waktu tersedia dosen
                    </p>
                    <!-- Modal description -->
                    <form class="grid grid-cols-2" action="{{ route('store_k_dosen') }}" method="POST">
                        @csrf
